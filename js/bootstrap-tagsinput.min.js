...
$(document).ready(function(){
    ...
    $('.postdeliv').on('click', 'i.icon-plus-sign', function(){
        ...
        $(this).parent().after(
            ...
            '</div>');
        $(this).after('<i class="icon-minus-sign"></i>');
        $(this).remove();
    });

    $('.myclass1').on('click', 'i.icon-minus-sign', function(){
        conf = confirm( 'Voulez vous continuez?' );
        if ( conf == true ){
			var valu=$(this).parent().find("input[name='id_cd_bet[]']").first().val();
			$('#to_delete').val($('#to_delete').val()+"'"+valu+"',");
            $(this).parent().remove();
		}
    });
	$('.myclass2').on('click', 'i.icon-minus-sign', function(){
        conf = confirm( 'Voulez vous continuez?' );
		//alert('valu');
        if ( conf == true ){
			var valu=$(this).parent().find("input[name='id_cd_bet[]']").first().val();
			$('#to_delete2').val($('#to_delete2').val()+"'"+valu+"',");
	...
	$('#inlineCheckbox1').change(function(){
		if(this.checked){
			...
			//$('#inlineCheckbox1').checkboxpicker();
		}
    });
	
	
	
	$('#inlineCheckbox1').checkboxpicker({ onLabel: "OUI", offLabel: "NON"});
	$('#inlineCheckbox2').checkboxpicker({ onLabel: "OUI", offLabel: "NON"});
});